...
import { getBlog, updateBlog, type Blog } from "@/app/actions/blog";
import { uploadImage } from "@/app/actions/cloudinary";
import { Save, ArrowLeft, Loader2, Image as ImageIcon, Trash2, Upload } from "lucide-react";
        ...
        <div className="max-w-5xl mx-auto pb-20">
            ...
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-2xl font-display font-bold">Edit Story</h2>
                        <span className="text-neutral-500 text-sm">Update your post</span>
                    </div>
                </div>
                <div className="flex items-center gap-4">
