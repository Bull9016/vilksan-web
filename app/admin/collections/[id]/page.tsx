...
import { getCollection, updateCollection } from "@/app/actions/product";
        ...
        <div className="max-w-4xl mx-auto pb-20">
            ...
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-2xl font-display font-bold">Edit Collection</h2>
                        <span className="text-neutral-500 text-sm">Update collection details</span>
                    </div>
                </div>
                <button
                    onClick={handleSave}
